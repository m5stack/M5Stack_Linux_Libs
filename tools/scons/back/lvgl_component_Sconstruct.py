...
if os.environ.get('CONFIG_LVGL_COMPONENT_LVGL') is not None:
    COMPONENT_INFO["COMPONENT_ADD_SRCS"] += append_srcs_dir_all(os.path.join(PRIVATE_MODULE_DIR, 'lvgl', 'lvgl', 'src'))
    COMPONENT_INFO["COMPONENT_ADD_SRCS"] += append_srcs_dir_all(os.path.join(PRIVATE_MODULE_DIR, 'lvgl', 'lvgl', 'demos'))
    COMPONENT_INFO["COMPONENT_ADD_SRCS"] += append_srcs_dir_all(os.path.join(PRIVATE_MODULE_DIR, 'lvgl', 'lvgl', 'examples'))

if os.environ.get('CONFIG_LVGL_COMPONENT_LV_DRIVERS') is not None:
    COMPONENT_INFO["COMPONENT_ADD_SRCS"] += append_srcs_dir_all(os.path.join(PRIVATE_MODULE_DIR, 'lvgl', 'lv_drivers'))

############### Add include ###################
COMPONENT_INFO["COMPONENT_ADD_INCLUDE"] = ['include', os.path.join(PRIVATE_MODULE_DIR, 'lvgl')]
...
if os.environ.get('CONFIG_LVGL_COMPONENT_DYNAMIC') is not None:
