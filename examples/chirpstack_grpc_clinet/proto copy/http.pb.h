...
inline void HttpRule::unsafe_arena_set_allocated_get(std::string* get) {
  ...
  if (get) {
    set_has_get();
    pattern_.get_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), get, GetArena());
  }
...
inline void HttpRule::unsafe_arena_set_allocated_put(std::string* put) {
  ...
  if (put) {
    set_has_put();
    pattern_.put_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), put, GetArena());
  }
...
inline void HttpRule::unsafe_arena_set_allocated_post(std::string* post) {
  ...
  if (post) {
    set_has_post();
    pattern_.post_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), post, GetArena());
  }
...
inline void HttpRule::unsafe_arena_set_allocated_delete_(std::string* delete_) {
  ...
  if (delete_) {
    set_has_delete_();
    pattern_.delete__.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), delete_, GetArena());
  }
...
inline void HttpRule::unsafe_arena_set_allocated_patch(std::string* patch) {
  ...
  if (patch) {
    set_has_patch();
    pattern_.patch_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), patch, GetArena());
  }
