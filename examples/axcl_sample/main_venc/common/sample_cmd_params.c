...
AX_S32 SampleCmdLineParse(AX_S32 argc, AX_CHAR **argv, SAMPLE_VENC_CMD_PARA_T *pstPara)
{
    ...
    while ((ret = SampleGetOption(argc, argv, options, &prm)) != -1) {
        ...
        /* long options */
        case '0':
            if (strcmp(pPrm->longOpt, "devId") == 0) {
                cml->devId = atoi(optarg);
                break;
            }
            if (strcmp(pPrm->longOpt, "json") == 0) {
                cml->json = optarg;
                break;
            }
            ...
            if (strcmp(pPrm->longOpt, "bMultiChnPerf") == 0) {
                cml->bMultiChnPerf = atoi(optarg);
                break;
            }
            if (strcmp(pPrm->longOpt, "bJencSlice") == 0) {
                cml->bJencSlice = atoi(optarg);
                break;
            }
            ...
            if (strcmp(pPrm->longOpt, "bThumb") == 0) {
                cml->bThumb = atoi(optarg);
                break;
            }
            if (strcmp(pPrm->longOpt, "thumbW") == 0) {
                cml->thumbW = atoi(optarg);
                break;
            }
            if (strcmp(pPrm->longOpt, "thumbH") == 0) {
                cml->thumbH = atoi(optarg);
                break;
            }
            if (strcmp(pPrm->longOpt, "bExif") == 0) {
                cml->bExif = atoi(optarg);
                break;
            }
            if (strcmp(pPrm->longOpt, "epollType") == 0) {
                cml->epollType = atoi(optarg);
                break;
            }
