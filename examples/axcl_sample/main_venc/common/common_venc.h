...
typedef struct axSAMPLE_VENC_CMD_PARA_T
{
    ...
    /* for perf */
    AX_U32 vbCnt;
    AX_BOOL bPerf; /* test single channel encode performance */
    AX_BOOL bMultiChnPerf; /* test multi channel encode performance */
    AX_BOOL bJencSlice;
    AX_U64 vencLoopExit;
    /* fifo depth */
    AX_U8 inFifoDep;
    ...
    AX_U8 matrixCoeffs;
    /* for thumbnail image */
    AX_BOOL bThumb; /* encode thumbnail images */
    AX_U32 thumbW;  /* width of thumbnail images */
    AX_U32 thumbH;  /* height of thumbnail images */
    AX_BOOL bExif;
    AX_U8 epollType; /* 0: level trigger 1: edge trigger */
    AX_S32 devId;
    AX_CHAR *json;
