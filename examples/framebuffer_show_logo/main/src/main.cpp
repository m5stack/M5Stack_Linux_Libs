...
int main(int argc, char **argv)
{
    ...
    image_t *imglog = imlib_image_create(320, 240, PIXFORMAT_RGB565, 0, NULL, false);
    bmp_read(imglog, "/home/root/logo.bmp");
    imlib_printf_image_info(imglog);

    imlib_pixfmt_to(img, imglog, NULL);
    

    imlib_image_destroy(&img);
    imlib_image_destroy(&imglog);
